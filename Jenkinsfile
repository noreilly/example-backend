...
podTemplate(label: 'jenkins-pipeline', containers: [
        containerTemplate(name: 'jnlp', image: 'jenkins/jnlp-slave:3.10-1-alpine', args: '${computer.jnlpmac} ${computer.name}', workingDir: '/home/jenkins', resourceRequestCpu: '20m', resourceLimitCpu: '40m', resourceRequestMemory: '256Mi', resourceLimitMemory: '512Mi', ttyEnabled: true),
    ...
    node('jenkins-pipeline') {
        ...
        def pwd = pwd()
        def chart_dir = "${pwd}/charts/example-backend"
